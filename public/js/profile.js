...
import { db, storage } from "./firebase-config.js?v=85";
import {
...
import { VIBE_META, initials, avatarColor, showToast } from "./ui.js?v=85";
...
export async function downgradeSubscription() {
  ...
  try {
    ...
    const { updateProfileUI } = await import('./profile.js?v=85');
    updateProfileUI();
  } catch(e) {
