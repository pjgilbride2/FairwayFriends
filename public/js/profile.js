...
import { db, storage } from "./firebase-config.js?v=109";
import {
...
import { VIBE_META, initials, avatarColor, showToast } from "./ui.js?v=109";
...
export async function downgradeSubscription() {
  ...
  try {
    ...
    const { updateProfileUI } = await import('./profile.js?v=109');
    updateProfileUI();
  } catch(e) {
