...
import { db, storage } from "./firebase-config.js?v=94";
import {
...
import { VIBE_META, initials, avatarColor, showToast } from "./ui.js?v=94";
...
export async function downgradeSubscription() {
  ...
  try {
    ...
    const { updateProfileUI } = await import('./profile.js?v=94');
    updateProfileUI();
  } catch(e) {
