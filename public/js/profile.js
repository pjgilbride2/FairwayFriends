...
import { db, storage } from "./firebase-config.js?v=110";
import {
...
import { VIBE_META, initials, avatarColor, showToast } from "./ui.js?v=110";
...
export async function downgradeSubscription() {
  ...
  try {
    ...
    const { updateProfileUI } = await import('./profile.js?v=110');
    updateProfileUI();
  } catch(e) {
