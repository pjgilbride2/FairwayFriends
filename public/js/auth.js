...
import { auth, db } from "./firebase-config.js?v=82";
import {
...
import { loadUserProfile } from "./profile.js?v=82";
import { initNotifications, teardownNotifications } from "./notifications.js?v=82";
import { initFeed, initNearbyPlayers, teardownListeners } from "./feed.js?v=82";
import { goScreen, hideSplash } from "./ui.js?v=82";
