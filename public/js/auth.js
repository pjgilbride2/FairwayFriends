...
import { loadUserProfile } from "./profile.js?v=46";
import { initNotifications, teardownNotifications } from "./notifications.js?v=46";
import { initFeed, initNearbyPlayers, teardownListeners } from "./feed.js?v=46";
import { goScreen, hideSplash } from "./ui.js?v=46";
