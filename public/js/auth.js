...
import { loadUserProfile } from "./profile.js?v=3";
import { initFeed, initNearbyPlayers, teardownListeners } from "./feed.js?v=3";
import { goScreen, hideSplash } from "./ui.js?v=3";
