...
import { auth, db } from "./firebase-config.js?v=65";
import {
...
import { loadUserProfile } from "./profile.js?v=65";
import { initNotifications, teardownNotifications } from "./notifications.js?v=65";
import { initFeed, initNearbyPlayers, teardownListeners } from "./feed.js?v=65";
import { goScreen, hideSplash } from "./ui.js?v=65";
