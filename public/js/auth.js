...
import { auth, db } from "./firebase-config.js?v=84";
import {
...
import { loadUserProfile } from "./profile.js?v=84";
import { initNotifications, teardownNotifications } from "./notifications.js?v=84";
import { initFeed, initNearbyPlayers, teardownListeners } from "./feed.js?v=84";
import { goScreen, hideSplash } from "./ui.js?v=84";
