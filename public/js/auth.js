...
import { loadUserProfile } from "./profile.js?v=2";
import { initFeed, initNearbyPlayers, teardownListeners } from "./feed.js?v=2";
import { goScreen, hideSplash } from "./ui.js?v=2";
