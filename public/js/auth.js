...
import { auth, db } from "./firebase-config.js?v=74";
import {
...
import { loadUserProfile } from "./profile.js?v=74";
import { initNotifications, teardownNotifications } from "./notifications.js?v=74";
import { initFeed, initNearbyPlayers, teardownListeners } from "./feed.js?v=74";
import { goScreen, hideSplash } from "./ui.js?v=74";
