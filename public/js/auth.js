...
import { auth, db } from "./firebase-config.js?v=77";
import {
...
import { loadUserProfile } from "./profile.js?v=77";
import { initNotifications, teardownNotifications } from "./notifications.js?v=77";
import { initFeed, initNearbyPlayers, teardownListeners } from "./feed.js?v=77";
import { goScreen, hideSplash } from "./ui.js?v=77";
