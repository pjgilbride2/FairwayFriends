...
import { auth, db } from "./firebase-config.js?v=49";
import {
...
import { loadUserProfile } from "./profile.js?v=49";
import { initNotifications, teardownNotifications } from "./notifications.js?v=49";
import { initFeed, initNearbyPlayers, teardownListeners } from "./feed.js?v=49";
import { goScreen, hideSplash } from "./ui.js?v=49";
