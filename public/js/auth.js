...
import { auth, db } from "./firebase-config.js?v=79";
import {
...
import { loadUserProfile } from "./profile.js?v=79";
import { initNotifications, teardownNotifications } from "./notifications.js?v=79";
import { initFeed, initNearbyPlayers, teardownListeners } from "./feed.js?v=79";
import { goScreen, hideSplash } from "./ui.js?v=79";
