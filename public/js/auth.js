...
import { auth, db } from "./firebase-config.js?v=78";
import {
...
import { loadUserProfile } from "./profile.js?v=78";
import { initNotifications, teardownNotifications } from "./notifications.js?v=78";
import { initFeed, initNearbyPlayers, teardownListeners } from "./feed.js?v=78";
import { goScreen, hideSplash } from "./ui.js?v=78";
