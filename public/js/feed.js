...
import { db, storage } from "./firebase-config.js?v=70";
import {
...
import { myProfile, myVibes } from "./profile.js?v=70";
import { createNotification } from "./notifications.js?v=70";
import { loadRoundDayForecast } from "./weather.js?v=70";
import {
