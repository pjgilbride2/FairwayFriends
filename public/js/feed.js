...
import { db, storage } from "./firebase-config.js?v=37";
import {
...
import { myProfile, myVibes } from "./profile.js?v=37";
import { createNotification } from "./notifications.js?v=37";
import { loadRoundDayForecast } from "./weather.js?v=37";
import {
