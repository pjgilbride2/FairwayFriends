...
import { db, storage } from "./firebase-config.js?v=63";
import {
...
import { myProfile, myVibes } from "./profile.js?v=63";
import { createNotification } from "./notifications.js?v=63";
import { loadRoundDayForecast } from "./weather.js?v=63";
import {
