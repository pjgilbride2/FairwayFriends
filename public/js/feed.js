...
import { db, storage } from "./firebase-config.js?v=21";
import {
...
import { myProfile, myVibes } from "./profile.js?v=21";
import { createNotification } from "./notifications.js?v=21";
import { loadRoundDayForecast } from "./weather.js?v=21";
import {
