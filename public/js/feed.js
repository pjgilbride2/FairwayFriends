...
import { db, storage } from "./firebase-config.js?v=45";
import {
...
import { myProfile, myVibes } from "./profile.js?v=45";
import { createNotification } from "./notifications.js?v=45";
import { loadRoundDayForecast } from "./weather.js?v=45";
import {
