...
import { auth, db } from "./firebase-config.js?v=110";
import {
...
import { loadUserProfile } from "./profile.js?v=110";
import { initNotifications, teardownNotifications } from "./notifications.js?v=110";
import { initFeed, initNearbyPlayers, teardownListeners } from "./feed.js?v=110";
import { goScreen, hideSplash } from "./ui.js?v=110";
